...
longitude       = -63.5497       ### Longitude of Simulation spill location - format Decimal degrees (float)
latitude        = 10.8107          ### Latitude of Simulation spill  - format Decimal degrees (float)
...
oil_volume      = 1.50*120            ### Volume of oil in tons - format (float) 
