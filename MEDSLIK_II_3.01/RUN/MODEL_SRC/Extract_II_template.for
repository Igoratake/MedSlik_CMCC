...
c********************************************************************
c     Extract and transform CURRENT FIELDS
c********************************************************************
      subroutine ExtractCURR(fc_dir,len_dir)

      parameter(ktmx=24, imx=169, jmx=157, kmx=4)
...
c--------------------------------------------------------------------
     ...
     & 'TEMP/OCE/'//'merc'//indate(n)(1:6)//ora(1:2)//'.mrc'
      open(20,file = outfile)
        write(20,*) 'Forecasted ocean fields for '//prdate
...
c********************************************************************
      subroutine ExtractWIND(fc_dir,len_dir)
       ...
       parameter(ktmx=24, imx=29, jmx=27)
...
c--------------------------------------------------------------------
     ...
     &                  indate(n)(3:4)
        write(6,*) 'Writing medslik WIND fields for date '//prdate
        write(99,*) 'Writing medslik WIND fields for date '//prdate
        outfile =
