...
#    cfres.cnLevels                  = np.arange(0.01,30,(30-0.01)/14)
    cfres.cnLevels                  = [ 0.005,0.1,0.25,0.5,0.75,1.,1.5,2.,2.5,
                                        3.,3.5,4.,4.5,5.,7.5,10.,12.5,15.]
...
# 9. SAMPLE MARKER SETUP --------------------------------------------------------------------
    ...
    m1res.gsMarkerColor             = "black"
    m1res.gsMarkerIndex             = 16

    m2res.gsMarkerSizeF             = 8.0
    m2res.gsMarkerColor             = "black"
...
#    mpres.mpFillColors               = ["background","transparent","transparent","transparent"]
    ...
    mpres.mpFillColors               = ["background","transparent","background","background"]
...
# 19. Draw text strings after the plot is drawn to make sure plot gets maximized properly --------
    ...
    Ngl.text_ndc(wks,string, 0.335, 0.930, txres)
