...
for i in xrange(2):
    ...
    if i == 0:
       ...
       out_name         = "eul_BEACON_trajectory"
       SIM = [1,2,3]
       LEG = [0,1,2,3]
    if i == 1:
       out_dir = "../OUTPUT/RUNGE_SG_drifter_test_case/"
       out_name         = "run_BEACON_trajectory"
       SIM = [1,3]
       LEG = [0,1,3]
# Plot -------------------------
...
#    for j in xrange(76):  # 24h
    for j in xrange(182): # 48h
