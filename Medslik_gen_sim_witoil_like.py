...
if __name__ == '__main__':
    ...
    subprocess.run([f'cp -r MEDSLIK_II_3.01/OUT/MDK_SIM_{dt_sim.year:02d}_{str(dt_sim.month).zfill(2)}_{str(dt_sim.day).zfill(2)}_{str(dt_sim.hour).zfill(2)}{str(dt_sim.minute).zfill(2)}_{simname}/ {simdir}{simname}/out_files/'],shell=True)
