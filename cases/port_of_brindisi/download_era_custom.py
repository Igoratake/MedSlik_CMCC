...
xmin = np.floor(np.float(16.4890909091))
xmax = np.ceil(np.float(19.6309090909))
ymin = np.floor(np.float(39.0930909091))
ymax = np.ceil(np.float(42.2349090909))

# Set your period of interest
iStartDate = date(2021,10,12).toordinal()
iEndDate = date(2021,10,15).toordinal()

# Define output folder
out_folder = '/scratch/work/lab/port_of_brindisi/met_files/'
