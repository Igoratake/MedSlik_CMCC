...
ds_base = xr.open_dataset(path_origin + f'OCE/MEDffE060830_01_grid_V.nc')
latt = ds_base.nav_lat.values
lonn = ds_base.nav_lon.values

date_list = pd.date_range('2006-07-12','2006-08-10')
...
for date in date_list:
    ...
    d1 = glob(path_origin + f'OCE/MEDffE06{month:02d}{day:02d}*.nc')
...
### MET STATE FILES ###    
#Selecting all the netcdf files from the chosen day
    met = xr.open_mfdataset(path_origin + f'MET/2006{month:02d}{day:02d}*.nc')
