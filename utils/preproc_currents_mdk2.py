...
def open_mercator_subset(sFileName,grid_corners):
	...
	iTime=date(1950,01,1).toordinal() + iTime/24 # time converted to standard pythonic time
...
iInputFolder = '/Users/asepp/work/data/mercator_9km/'

# Define where outputs will be placed (MEDSLIK-adapted nc files)
iStorageDirectory= "/Users/asepp/work/data/paria/oce_files_mercator/"

# Define start and end data of the pre-processing
# It will depend on your input data, of course, and on your simulation setup
iStartDate=date(2017,4,23).toordinal()
iEndDate=date(2017,5,13).toordinal()

# Requirements for temporal interpolation
# reference hours
iOutputRefHours=np.arange(13,37) # basically, you're saying you want hourly outputs
iInputRefHours=[12,36,50] # and that your CMEMS-GLO files are daily (obs at 12:00)

# Now, set the geographic limits of your preprocessing (you may have a large CMEMS file)
xE = -60. #easternmost coordinate
xW = -70. #westernmost coordinate
yN = 15.  #northernmost coordinate
yS = 5.   #southernmost coordinate
