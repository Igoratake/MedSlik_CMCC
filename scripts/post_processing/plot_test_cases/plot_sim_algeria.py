...
if __name__ == '__main__':
    ...
    path = '/Users/iatake/Dropbox (CMCC)/Work/MEDSLIK-II and Pyslick/Medslik-II_results/ORIGINAL_DATA/ALGERIA/'
    ...
    for t in range(0,47):
        ...
        for plot in ['particle','concentration']:
            ...
            plt.savefig(path + f'figures/fig_algeria_{t:03d}_{plot}.png',dpi=100)
