...
if __name__ == '__main__':
    ...
    path = '/Users/iatake/Dropbox (CMCC)/Work/MEDSLIK-II and Pyslick/Medslik-II_results/ORIGINAL_DATA/LEBANON102/'
    ...
    for t in [0,12,24,48,76,92,96,120,200,300,400,439]:
        ...
        for plot in ['particle','concentration']:
            ...
            plt.savefig(path + f'figures/fig_lebanon102_{t:03d}_{plot}.png',dpi=100)
