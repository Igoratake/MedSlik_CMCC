...
# for instance.
time_index = np.arange(0,sim_length,1)
...
# set where your coastline file is located
# most likely at something like:
# it should be in /scratch/work/lab/experiment_name/bnc_files/dtm.txt'
coast_file = '/scratch/work/lab/' + xp_name + '/bnc_files/dtm.txt'
