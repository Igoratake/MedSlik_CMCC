...
def interp_gebco(iLatitude, iLongitude, Z, x_mod, y_mod):
	...
	print("==========================")
	print("+++++LONGITUDE LIMITS++++")
	print(iLongitudeMin,iLongitudeMax)
	print("+++++LATITUDE LIMITS++++")
	print(iLatitudeMin,iLatitudeMax)
	print("==========================")
...
gebco_filename = '/scratch/work/lab/data/gebco/gebco_08.nc'
...
# let us know where you've placed your current files
