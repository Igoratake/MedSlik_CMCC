...
F_DATA=/${INSTALLATION_FOLDER}/MEDSLIK_II_2.01/METOCE_INP #str



#source medslik_inputfile.txt	#str
source config1.txt
...
V='vomecrty'
T='votemper'
model='MERCATOR_global'
pre_name='MDK_ocean_'
tail_name=''
fi

#fcst_data=fcst_data
#FD=$F_DATA/$fcst_data/$dir	#str
PREPROC=PREPROC
...
dir_wind='MET'
#FD_wind_in=$F_DATA/$fcst_data/$dir_wind	#str
FD_wind_in=$F_DATA/$PREPROC/$dir_wind
#FD_wind=$F_DATA/$fcst_data/$dir_wind	#str
...
#############################################################
cp MODEL_SRC/medslikYYYY.tmp medslik0.tmp
...
#cp medslik5.inp  output/$DIR_output	#str
...
#mkdir output/$DIR_output/MET	#str
#mkdir output/$DIR_output/OCE

mkdir ../OUT/$DIR_output/MET
mkdir ../OUT/$DIR_output/OCE

#mv obs* output/$DIR_output	#str
mv obs* ../OUT/$DIR_output

if  [ $wind = 5 ]
then
#mv fcst_data/MET/*.* output/$DIR_output/MET	#str
#rm -f fcst_data/MET/*.eri
...
if  [ $currents = 74 ]
then
#mv fcst_data/OCE/*.* output/$DIR_output/OCE	#str
#rm -f fcst_data/OCE/*.mrc
