...
c********************************************************************
      ...
      parameter(ktmx=24, imx=121, jmx=121, kmx=4) 
...
c********************************************************************
      subroutine ExtractSKIRON(fc_dir,len_dir)
       ...
       parameter(ktmx=24, imx=43, jmx=19)
...
c--------------------------------------------------------------------
     ...
     &                  indate(n)(3:4)
        write(6,*) 'Writing medslik ERA-Interim file for date '//prdate
        write(99,*) 'Writing medslik ERA-Interim file for date '//prdate
        outfile =
...
c--------------------------------------------------------------------
     ...
     & 'TEMP/MET/'//'erai'//indate(n)(3:8)//'.eri'
      open(20,file = outfile)
        write(20,*) 'ERA-Interim forecast data for '//prdate 
